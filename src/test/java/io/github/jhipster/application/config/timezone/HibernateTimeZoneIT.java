...
import io.github.jhipster.application.JhipsterSampleSpringAngularApp;
 ...
 */
@SpringBootTest(classes = {JhipsterSampleSpringAngularApp.class, TestSecurityConfiguration.class})
